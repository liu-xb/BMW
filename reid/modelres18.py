...
class MyNet(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        self.resnet_layer = torchvision.models.resnet18(pretrained=False)
        
        self.resnet_layer.load_state_dict(torch.load('E:/torch_cache/hub/checkpoints/resnet18-f37072fd.pth'))
