...
class MyNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.resnet_layer.load_state_dict(torch.load('E:/torch_cache/hub/checkpoints/resnet50-11ad3fa6.pth'))  # or use resnet50(weights=models.ResNet50_Weights.DEFAULT)
